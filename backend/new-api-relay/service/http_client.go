...
func ValidateProtectedRelayHTTPEnvironment() error {
	if PlatformRelayProductionSecurityEnabled() && common.ProtectedRawSecretEnvironmentPresent(os.Environ()) {
		return errors.New("protected Relay HTTP environment is invalid")
	}
	return nil
}

func InitHttpClient() error {
	if err := ValidateProtectedRelayHTTPEnvironment(); err != nil {
		return err
	}
