...
func TestMain(m *testing.M) {
	_ = os.Setenv(providerCredentialKeyringJSONEnvironment, `{"schema_version":1,"active_key_id":"test-v1","keys":{"test-v1":"MDEyMzQ1Njc4OWFiY2RlZjAxMjM0NTY3ODlhYmNkZWY="}}`)
...
func truncateTables(t *testing.T) {
	...
	t.Cleanup(func() {
		...
		DB.Exec("DELETE FROM provider_credential_versions")
		DB.Exec("DELETE FROM provider_channel_credential_set_versions")
