...
func InitEnv() {
	...
	protectedSessionSecret, protectedCryptoSecret, protectedSecretsConfigured := protectedRelayApplicationSecrets()
	sessionSecret := os.Getenv("SESSION_SECRET")
	cryptoSecret := os.Getenv("CRYPTO_SECRET")
	if protectedSecretsConfigured {
		sessionSecret = protectedSessionSecret
		cryptoSecret = protectedCryptoSecret
	}
	if sessionSecret != "" {
		ss := sessionSecret
		if ss == "random_string" {
