...
func setupModelListControllerTestDB(t *testing.T) *gorm.DB {
	...
	t.Setenv("RELAY_PROVIDER_CREDENTIAL_KEYRING_JSON", `{"schema_version":1,"active_key_id":"controller-test-v1","keys":{"controller-test-v1":"MDEyMzQ1Njc4OWFiY2RlZjAxMjM0NTY3ODlhYmNkZWY="}}`)

	require.NoError(t, db.AutoMigrate(&model.User{}, &model.Channel{}, &model.ProviderChannelCredentialSetVersion{}, &model.Ability{}, &model.Model{}, &model.Vendor{}))
