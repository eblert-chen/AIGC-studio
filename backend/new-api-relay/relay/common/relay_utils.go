...
func ValidateMultipartDirect(c *gin.Context, info *RelayInfo) *dto.TaskError {
	...
	if strings.TrimSpace(req.InputReference) != "" {
		// input_reference is a video input in the Platform generation bridge.
		// Keep it distinct from image inputs so provider adaptors can preserve
		// media types and optional last-frame images.
